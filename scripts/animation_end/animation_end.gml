...
///		the reate of change in frames per step if not
///		using built in image_index/image_speed.
///		Dont't use if you dont think you need this. you probably dont

// returns true if the animtion will loop this step

//script courtesy of PixellatedPope & Minty Python from the GameMaker Subreddit discord
//https:/www.redit.com/r/gamemaker/wiki/discord
...
//is the animation about to loop this step?